...
class ArticleCommentsControllerTest < ActionController::TestCase
  ...
  test "should create article_comment" do
    assert_difference('ArticleComment.count') do
      post :create, article_comment: { article_id: @article_comment.article_id, content: @article_comment.content, user_id: @article_comment.user_id }
    end
  ...
  test "should update article_comment" do
    patch :update, id: @article_comment, article_comment: { article_id: @article_comment.article_id, content: @article_comment.content, user_id: @article_comment.user_id }
    assert_redirected_to article_comment_path(assigns(:article_comment))
  end
